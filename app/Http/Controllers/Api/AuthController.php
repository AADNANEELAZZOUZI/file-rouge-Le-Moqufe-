...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        $request->validate([
            ...
            // ✅ Categories — array d'IDs, requis si artisan
            'categories'   => 'required_if:role,artisan|array|min:1',
        ...
        // ✅ Attacher les catégories si artisan
    ...
    public function updateProfile(Request $request)
    {
        ...
        // ✅ Sync les catégories si envoyées
